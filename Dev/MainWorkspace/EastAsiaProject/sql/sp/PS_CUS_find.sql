...
select cus_id, 
		concat_ws(', ', if(cus_name_last = '', null, cus_name_last), if(cus_name_first = '', null, cus_name_first)) as cus_name,
 ...
 where ($cus_name is null or concat_ws(', ', if(cus_name_last = '', null, cus_name_last), if(cus_name_first = '', null, cus_name_first)) like concat('%', $cus_name, '%'))
