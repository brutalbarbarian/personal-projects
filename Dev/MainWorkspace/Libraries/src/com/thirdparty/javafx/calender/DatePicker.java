package com.thirdparty.javafx.calender;
...
/**
 * http://javafxwidgets.blogspot.co.nz/2012/01/simple-calendar-for-javafx-20.html
 * 
...
public class DatePicker extends HBox {
    ...
    protected BooleanProperty _showingProperty() {
    ...
    public boolean isShowing() {
    	return showingProperty().getValue();
    }
    
    // Will reuturn null isShowing() is false
